...
![Scan Report Page](/path/to/scan_report_screenshot.png)
*Figure 2: The combined NMAP & Threat Intelligence detailed view.*

![History Page](/path/to/history_screenshot.png)
*Figure 3: Historical tracking and advanced analytics heatmaps.*
